...
namespace AirtableApiClient.Tests
{
    ...
    public class AtApiClientTests
    {
        ...
        {           
            ...
            string bodyText = 
                "{\"cellFormat\":\"json\",\"returnFieldsByFieldId\":false}";
        ...
        public async Task TcAtApiClientFieldsTest()
        {
            ...
            string bodyText = "{\"fields\":[\"Name\",\"Collection\"],\"cellFormat\":\"json\",\"returnFieldsByFieldId\":false}";
        ...
        public async Task TdAtApiClientFieldsTestUsingFieldId()
        {
           ...
           string bodyText = "{\"fields\":[\"fldSAUw6qVy9NzXzF\",\"fldE0muAk6ejOkkKa\"],\"cellFormat\":\"json\",\"returnFieldsByFieldId\":false}";
        ...
        public async Task TefAtApiClientFilterByFormulaTest()
        {
            ...
            string bodyText = "{\"filterByFormula\":\"({On Display?} = 1)\",\"cellFormat\":\"json\",\"returnFieldsByFieldId\":false}";
        ...
        public async Task TfAtApiClientMaxRecordsTest()
        {
            ...
            string bodyText = "{\"maxRecords\":4,\"cellFormat\":\"json\",\"returnFieldsByFieldId\":false}";
            fakeResponseHandler.AddFakeResponse(
                BASE_URL + "/listRecords",
                HttpMethod.Post,
                fakeResponse,
        ...
        public async Task TgAtApiClientViewTest()
        {
            ...
            string bodyText = "{\"view\":\"Gallery View\",\"cellFormat\":\"json\",\"returnFieldsByFieldId\":false}";
            fakeResponseHandler.AddFakeResponse(
                BASE_URL + "/listRecords",
                HttpMethod.Post,
        ...
        public async Task ThAtApiClientSortTest()
        {
            ...
            string bodyText = "{\"sort\":[{\"field\":\"Name\",\"direction\":\"desc\"},{\"field\":\"Genre\",\"direction\":\"asc\"}],\"cellFormat\":\"json\",\"returnFieldsByFieldId\":false}";
            fakeResponseHandler.AddFakeResponse(
                    BASE_URL + "/listRecords",
                    HttpMethod.Post,
                    fakeResponse,
        ...
        public async Task TwAtApiClientListRecordsReturnFieldsFieldIdTest()
        {
            ...
            string bodyText = "{\"maxRecords\":3,\"cellFormat\":\"json\",\"returnFieldsByFieldId\":true}";
        ...
        {
            fakeResponse.Content = new StringContent
                ("{\"records\":[{\"id\":\"rec6vpnCofe2OZiwi\",\"createdTime\":\"2015-02-09T23:24:14.000Z\",\"fields\":{\"On Display?\":\"checked\",\"Genre\":\"American Abstract Expressionism, Color Field\",\"Bio\":\"Al Held began his painting career by exhibiting Abstract Expressionist works in New York; he later turned to hard-edged geometric paintings that were dubbed “concrete abstractions”. In the late 1960s Held began to challenge the flatness he perceived in even the most modernist painting styles, breaking up the picture plane with suggestions of deep space and three-dimensional form; he would later reintroduce eye-popping colors into his canvases. In vast compositions, Held painted geometric forms in space, constituting what have been described as reinterpretations of Cubism.\",\"Name\":\"Al Held\",\"Testing Date\":\"1970-11-29 11:00am\",\"Collection\":\"Transcontinental Legacy\",\"Attachments\":\"Quattro_Centric_XIV.jpg (https://v5.airtableusercontent.com/v1/15/15/1678176000000/cLzPASbaf-nhf0UfjMacog/5ZzgWwVWbZnjCK9e7QPrcwnasstesEAxOOSpdVHw-NCUmnMnhP1rAeKoiTKe8QUP/XIXlu3ElxqKk51hWBuABlWSjBBl6T7ksD_eEwggKJ3Y), Roberta's_Trip.jpg (https://v5.airtableusercontent.com/v1/15/15/1678176000000/6uSGZ3L7CwDmn81y4fV47A/HxMfXfYFw-q8F5wMfBH6E6F07GBwfQA5rRZ5IxaoPaBU0-woASJb1HyObbOdnkbW/xY0We1wUPocACDziCd7dMJzY-laE37M1vLCA-yp8Td8), Bruges_III.jpg (https://v5.airtableusercontent.com/v1/15/15/1678176000000/tpgBurj4DgwM4D4oyMu8fw/33zbSb-H7s_rhimfgPYOB_WtMWrD4my1jSVBKYyr9f0fjUpigvljfon7Fk5lh0vQ/F39PORYT5jJFnaoQgu7H7PoFgaw7b8gi5UU5bi-AoCA), Vorcex_II.jpg (https://v5.airtableusercontent.com/v1/15/15/1678176000000/5pBQrmc_Va3eZ2qZaxflBA/eUHxbkdQnKveKniHv3wCx9H2h4If3-ExlGgOt_TIMfpkaw7Lpm7RtvraY8mXb1ts/gQs8RdaTIE4sWfsG9elUutFUico-SP6_unPver9nx54)\"}},{\"id\":\"rec8rPRhzHPVJvrL3\",\"createdTime\":\"2015-02-09T23:04:03.000Z\",\"fields\":{\"On Display?\":\"checked\",\"Genre\":\"Abstract Expressionism, Modern art\",\"Bio\":\"Arshile Gorky had a seminal influence on Abstract Expressionism. As such, his works were often speculated to have been informed by the suffering and loss he experienced of the Armenian Genocide.\\n\\n\",\"Name\":\"Arshile Gorky\",\"Collection\":\"Transcontinental Legacy\",\"Attachments\":\"Master-Bill.jpg (https://v5.airtableusercontent.com/v1/15/15/1678176000000/BkLlGmrRyvPPVe2K9CLs5g/Xa5z1OLqQajIc3s5rUniFlqdJtaRLITP1gDihXUjv9mU-oL-UYW2vch6-LycxAE6/-WytnHsMpCFISk34tpKtqbCgebJHwBskHCmfCQuGyy4), The_Liver_Is_The_Cock's_Comb.jpg (https://v5.airtableusercontent.com/v1/15/15/1678176000000/yyxzI3AUu_1wrHeDrg01Mw/3vhh48bD9WrbGAy6dPEkLigmlptj4u36J06Tny2NpvGo8hUKjuLWuAFf_zZ1TXHXlVX9Zunx8W2Jpe-An581BQ/MtAshO4rp54zZ8mEc5fSznfz8rXALER1HhxkL693H2k), Garden-in-Sochi-1941.jpg (https://v5.airtableusercontent.com/v1/15/15/1678176000000/nz6cidGit13btuinqJkSRA/1LNtH-aBONGMEZlPPc1UG1AmZ32VUbnkbQYnHMdv3xx6ZVJ7Y5Xv9Eu4MKO-0k2R/ow2_L8qrL-eSyBjKB9odvpgvML0-HIBmApTJOS4euEk)\"}},{\"id\":\"recTGgsutSNKCHyUS\",\"createdTime\":\"2015-02-10T16:53:03.000Z\",\"fields\":{\"Genre\":\"Post-minimalism, Color Field\",\"Bio\":\"Miya Ando is an American artist whose metal canvases and sculpture articulate themes of perception and one's relationship to time. The foundation of her practice is the transformation of surfaces. Half Japanese & half Russian-American, Ando is a descendant of Bizen sword makers and spent part of her childhood in a Buddhist temple in Japan as well as on 25 acres of redwood forest in rural coastal Northern California. She has continued her 16th-generation Japanese sword smithing and Buddhist lineage by combining metals, reflectivity and light in her luminous paintings and sculpture.\",\"Name\":\"Miya Ando\",\"Collection\":\"Color Field\",\"Attachments\":\"blue+light.jpg (https://v5.airtableusercontent.com/v1/15/15/1678176000000/4h4YOhia5UoxRQyXWlqZwQ/jAS34TE0c05wY5ApMzikxRgKfs9d_5Yt-oiK362RAmGxd4C6hJBqY5lSLIqB_nRd/Gl4fevqda9gebf0lgRBq1f9FNliocdEvNaUjO3_1QOU), miya_ando_sui_getsu_ka_grid-copy.jpg (https://v5.airtableusercontent.com/v1/15/15/1678176000000/msU9gIldhQwxOtpYHWGFXw/5KY7IuIARWJHPTfCEtL_ua_1eKW5KpWusBocMIMlHjJyv1tIlNjHaSPxeljA82FNztToRReJN_f9eoc0Cdd-Jg/4cui0B_MkRHAmMc0tZapyWgEmideiIEBjAOxmjzpO70), miya_ando_blue_green_24x24inch_alumium_dye_patina_phosphorescence_resin-2.jpg (https://v5.airtableusercontent.com/v1/15/15/1678176000000/MrKdwR47aaSYD8brzMea8g/XpVUKBxsM8aTd1cMoSg5LYI2zcEGD9ZtsQ4Cywj0kZKFGSeeTBFDKJ4Qxd7PbUiaU-L58y5aFxqd_Hx3lZep0owMVy5Db5t5vtAedK4heP9Z74rsoX2ACGq41oLFmHfOWdWVUv3t6yFNA7rSH5X3Rw/G_UuUaXXzkDgdgpwM-ZI4wS-joN3Uxo3ct-IIyA3XfI), miya_ando_shinobu_santa_cruz_size_48x48inches_year_2010_medium_aluminum_patina_pigment_automotive_lacquer.jpg (https://v5.airtableusercontent.com/v1/15/15/1678176000000/nX_QE9_YMUsAccWFk3qV1A/BsJoGMlkOvX8_lgPUQJdkXmNxeYW5VdgafXCprWsRDCpNprm9k5LwVSF4AWCObfYB_b_SfZBsauTgsdQ6O7FDHQvhG8xrPJxiySXwnZKm2jAKJ-V7cSTjM6WWvTKrx-ia6tAcY3OsTBhkQ1t3jcyruipSHXabGSJRVjlXw2tna6dBbPyKcqRIWxnzP81qdnE/EuMlFaw915U2Puvzt8jLmY1ie2xobrOLR5__3d-CNvY)\"}}]}");

            fakeResponseHandler.AddFakeResponse(
                BASE_URL + "?maxRecords=3&timeZone=Asia%2fHo_Chi_Minh&userLocale=fr-ca&cellFormat=string",
                HttpMethod.Get,
                fakeResponse,
                null);
            ...
            string bodyText = "{\"maxRecords\":3,\"cellFormat\":\"json\",\"timeZone\":\"Asia/Ho_Chi_Minh\",\"returnFieldsByFieldId\":false}";
            ...
            bodyText = "{\"maxRecords\":3,\"cellFormat\":\"json\",\"userLocale\":\"fr-ca\",\"returnFieldsByFieldId\":false}";
            ...
            bodyText = "{\"maxRecords\":3,\"cellFormat\":\"json\",\"timeZone\":\"Asia/Ho_Chi_Minh\",\"userLocale\":\"fr-ca\",\"returnFieldsByFieldId\":false}";
        ...
        public async Task TzDAtApiClientTooManyRecordsErrorTest()
        {
            ...
            string bodyText = "{\"cellFormat\":\"json\",\"returnFieldsByFieldId\":false}";
        ...
        public async Task TzHAtApiClientListRecordsCommentCountTest()
        {
            ...
            string bodyText = "{\"recordMetadata\":\"commentCount\",\"maxRecords\":3,\"cellFormat\":\"json\",\"returnFieldsByFieldId\":false}";
