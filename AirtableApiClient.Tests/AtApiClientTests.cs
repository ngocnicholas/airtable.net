...
namespace AirtableApiClient.Tests
{
    ...
    public class AtApiClientTests
    {
        ...
        public async Task TzWAtApiClientRGetBaseSchema()
        {
            ...
            // appptCKqFJAp3l1mo (use this base for testing the aiText field example)
            //Task<AirtableGetBaseSchemaResponse> task = airtableBase.GetBaseSchema(scInclude, "appptCKqFJAp3l1mo");
